...
#bus.write_byte_data(addr, 0xfe, 0x78) #changes the Prescale register value for 50 Hz, using the equation in the datasheet.
#bus.write_byte_data(addr, 0xfe, 0x79) #changes the Prescale register value for 50 Hz, using the equation in the datasheet.
#bus.write_byte_data(addr, 0xfe, 0x7A) #changes the Prescale register value for 50 Hz, using the equation in the datasheet.
#bus.write_byte_data(addr, 0xfe, 0x7B) #changes the Prescale register value for 50 Hz, using the equation in the datasheet.
bus.write_byte_data(addr, 0xfe, 0x7C) #changes the Prescale register value for 50 Hz, using the equation in the datasheet.
bus.write_byte_data(addr, 0, 0x20) # enables word writes
