...
i2c_bus.write_word_data(PCA9685_ADDRESS, LED0_OFF_L, 209) # 1.0ms (0 degrees)

time.sleep(2)
#i2c_bus.write_word_data(PCA9685_ADDRESS, LED0_OFF_L, 1550)
i2c_bus.write_word_data(PCA9685_ADDRESS, LED0_OFF_L, 312) # 1.5ms (45 degrees)

time.sleep(2)
i2c_bus.write_word_data(PCA9685_ADDRESS, LED0_OFF_L, 416) # 2.0ms (90 degrees)
