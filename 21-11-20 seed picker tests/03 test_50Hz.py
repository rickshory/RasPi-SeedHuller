# goes to middle position (300), then waits for manual control
...
# practical limits are 162 and 464 for a range of about 120 degrees
# this is emperical, from a HK-5330S servo motor
...
time_high = 300
i2c_bus.write_word_data(PCA9685_ADDRESS, LED0_OFF_L, time_high) # 1.5ms (45 degrees)
